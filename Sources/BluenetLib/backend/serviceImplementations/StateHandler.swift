...
public class StateHandler {
    ...
    public func _getState<T>(_ requestPacket: [UInt8], id: UInt16 = 0) -> Promise<T> {
        ...
        return Promise<T> { seal in
            ...
            _writePacketWithReply(bleManager: self.bleManager, handle: self.handle, service: stateParams.service, readCharacteristic: stateParams.characteristic, writeCommand: writeCommand)
